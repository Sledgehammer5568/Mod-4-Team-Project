...
if IN == 1:  # this option prints out a greeting using the users name
    ...
    a group activity. This can be fun if you are challenging yourself to making a self portrait, some inspiration, 
    methods, etc. If it was a group activity then some chaotic fun like trying something new with others is a good way
    to discover your outlook with others.""")  # Thought to add a calming activity lol - DS

elif IN == 8:
    print("""You choose option 8. So you want to mentally and physically challenge yourself in the battle of building 
    a personal computer!? Well this option is rightfully descriptive. First build a list of parts you want to 
    include, YouTube and computer building forums (like reddit) are your best friend to needing answers to curious 
    questions. Then buy the parts which is seemingly the hardest part depending on your financial situation. Finally, 
    either get a friend to help you build it or build the PC yourself. Again Youtube is your best friend for any 
